...
class TestEndpoint(unittest.TestCase):
    def test_endpoint(self):
        questionUrl = baseUrl + f"question/UTEST/U01" + "?format=json"
        vescookie = getCookie()
        response = requests.get(url = questionUrl, verify = False, cookies = vescookie)
...
if __name__ == "__main__":
    ...
    print(f"Question Unit Test Result:\t\t\t{result}")