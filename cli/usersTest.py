...
class TestEndpoint(unittest.TestCase):
    def test_endpoint(self):
        ...
        usermodUrl = baseUrl + f"admin/users/{username}" + "?format=json"
        vescookie = getCookie()
        response = requests.get(url = usermodUrl, verify = False, cookies = vescookie)
...
if __name__ == "__main__":
    ...
    print(f"Users Unit Test Result:\t\t\t\t{result}")