...
import os
os.environ["REQUESTS_CA_BUNDLE"] = "C:\\Users\\dhmht\\AppData\\Local\\Programs\\Python\\Python310\\lib\\site-packages\\certifi\\cacert.pem"
os.environ["SSL_CERT_FILE"] = "C:\\Users\\dhmht\\AppData\\Local\\Programs\\Python\\Python310\\lib\\site-packages\\certifi\\cacert.pem"

import ssl                                                                                                                                                                                             
ssl.match_hostname = lambda cert, hostname: hostname == cert['subjectAltName'][0][1]

baseUrl = "https://localhost:3000/intelliq_api/"
...
def handlePost(url, verify, json_data = {}, headers = {}):
    try:
        if (json_data == {} and headers == {}):
            response = requests.post(url, verify = verify, timeout=10)
...
def login(username, password, form):
    ...
    cert_path = "C:\\Users\\dhmht\\AppData\\Local\\Programs\\Python\\Python310\\lib\\site-packages\\certifi\\cacert.pem"
...
parser = argparse.ArgumentParser()#add_help=cert_path)
