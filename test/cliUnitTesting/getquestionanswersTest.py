...
class TestEndpoint(unittest.TestCase):
    def test_endpoint(self):
        ...
        question_id = "U01"
        getquestionanswers = baseUrl + f"getquestionanswers/{questionnaire_id}/{question_id}" + "?format=json"
        vescookie = getCookie()
        response = requests.get(url = getquestionanswers, verify = False, cookies = vescookie)
...
if __name__ == "__main__":
    ...
    print(f"Getquestionanswers Unit Test Result:\t\t{result}")