...
class TestEndpoint(unittest.TestCase):
    def test_endpoint(self):
        healthUrl = baseUrl + "admin/healthcheck?format=json"

        vescookie = getCookie()

        response = requests.get(url = healthUrl, verify = False, cookies = vescookie)
...
if __name__ == "__main__":
    ...
    print(f"Healthcheck Unit Test Result:\t\t\t{result}")